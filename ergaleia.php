...
renderDeadlineCard(array(
    ...
    'note_html' => 'Στην ορκωμοσία/ανάληψη νεοδιορίστων, στην πρόσκληση νεοδιοριζομένων για αιτήσεις απόσπασης και στις προσκλήσεις αναπληρωτών και ΕΕΠ–ΕΒΠ δεν αναφέρεται συγκεκριμένη ώρα λήξης· το countdown θεωρεί τεχνικά το τέλος της αντίστοιχης καταληκτικής ημέρας. Οι επίσημες ανακοινώσεις, οι προσκλήσεις και οι ηλεκτρονικές πλατφόρμες υπερισχύουν.'
));
?>
...
<p>Υπολόγισε το διδακτικό ωράριο εκπαιδευτικών σε Νηπιαγωγείο, Δημοτικό ή Δευτεροβάθμια και το ωράριο υποστηρικτικού έργου του ΕΒΠ.</p>
<span class="button-like">Άνοιγμα εργαλείου →</span>
</a>
