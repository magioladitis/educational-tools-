<?php
/**
 * Central deadline data for the separate deadlines page.
 *
...
return array(
    ...
    'collapsible' => true,
    'expanded' => true,
    // Ληγμένες προθεσμίες παραμένουν ορατές για 7 ημέρες και μετά κρύβονται αυτόματα.
    // Τα δεδομένα τους διατηρούνται στο αρχείο ως ιστορικό.
    'archive_after_days' => 7,
    'items' => array(
        array(
            'title' => 'ΣΔΕ 2026–2027 — επικαιροποίηση αιτήσεων / δήλωση προτιμήσεων',
            'meta_html' => 'Για υποψηφίους στους οριστικούς πίνακες κατάταξης εκπαιδευτικού προσωπικού, συμβούλων σταδιοδρομίας και συμβούλων ψυχολόγων · επικαιροποίηση μέσω της πλατφόρμας ΣΔΕ από <strong>25/09/2026, 12:00</strong> έως <strong>29/09/2026, 12:00</strong>.',
            'start' => '2026-09-25T12:00:00+03:00',
            'end' => '2026-09-29T12:00:00+03:00',
            'source_url' => 'https://www.inedivim.gr/announcements_procla/%CE%B4%CE%B7%CE%BC%CE%BF%CF%83%CE%B9%CE%BF%CF%80%CE%BF%CE%AF%CE%B7%CF%83%CE%B7-%CE%B4%CE%B9%CE%B1%CE%B8%CE%AD%CF%83%CE%B9%CE%BC%CF%89%CE%BD-%CF%89%CF%81%CF%8E%CE%BD-%CF%84%CE%BC%CE%B7%CE%BC%CE%AC/',
            'source_label' => 'ΙΝΕΔΙΒΙΜ — επίσημη ανακοίνωση 24/09/2026 ↗',
            'open_text' => 'Η περίοδος επικαιροποίησης αιτήσεων είναι ανοικτή.',
            'before_text' => 'Η περίοδος επικαιροποίησης αιτήσεων δεν έχει ανοίξει ακόμη.',
            'closed_text' => 'Η προθεσμία επικαιροποίησης αιτήσεων έχει λήξει.'
        ),
        array(
            'title' => 'Μουσικά Σχολεία — εμπειροτέχνες ιδιώτες μουσικοί (ΕΜ16)',
            'meta_html' => 'Αίτηση–δήλωση ένταξης στον πίνακα ΕΜ16 και προτίμησης Μουσικών Σχολείων μέσω ΟΠΣΥΔ · από <strong>28/09/2026</strong> έως και <strong>02/10/2026</strong>. Η επίσημη πρόσκληση δεν ορίζει συγκεκριμένη ώρα λήξης.',
            'start' => '2026-09-28T00:00:00+03:00',
            'end_exclusive' => '2026-10-03T00:00:00+03:00',
            'source_url' => 'https://diavgeia.gov.gr/doc/%CE%A156%CE%9946%CE%9D%CE%9A%CE%A0%CE%94-%CE%9F6%CE%A3?inline=true',
            'source_label' => 'Πρόσκληση 127589/Ε1/25-09-2026 · ΑΔΑ Ρ56Ι46ΝΚΠΔ-Ο6Σ ↗',
        ...
        array(
            'title' => 'Ψηφιακό Φροντιστήριο — προσωρινοί αναπληρωτές 2026–2027',
            'meta_html' => 'Αιτήσεις πρόσληψης μέσω της ηλεκτρονικής πλατφόρμας του ΙΕΠ από <strong>24/09/2026, 14:00</strong> έως <strong>05/10/2026, 17:00</strong>.',
            ...
            'before_text' => 'Η περίοδος υποβολής αιτήσεων δεν έχει ανοίξει ακόμη.',
            'closed_text' => 'Η προθεσμία υποβολής αιτήσεων έχει λήξει.',
            'tool_url' => 'ypologismos-morion-anapliroti-psifiako-frontistirio.php',
            'tool_label' => 'Υπολόγισε μόρια →'
        ),
        array(
            'title' => 'ΣΔΕ 2026–2027 — ενστάσεις στους πίνακες δεκτών / μη δεκτών',
            'meta_html' => 'Για υποψηφίους της συμπληρωματικής πρόσκλησης αποσπάσεων μονίμων εκπαιδευτικών στα Σχολεία Δεύτερης Ευκαιρίας · ενστάσεις από <strong>24/09/2026</strong> έως και <strong>28/09/2026</strong>, αποκλειστικά ηλεκτρονικά.',
            'start' => '2026-09-24T00:00:00+03:00',
            'end_exclusive' => '2026-09-29T00:00:00+03:00',
            'source_url' => 'https://www.gsvetlly.minedu.gov.gr/nea-anakoinoseis/856-pinakes-dekton-kai-mi-dekton-ypopsifion-ekpaideftikon-gia-tis-apospaseis-sta-sde-2026-2027',
            'source_label' => 'ΥΠΑΙΘΑ — Πίνακες ΣΔΕ 23/09/2026 · ΑΔΑ 9Η5Θ46ΝΚΠΔ-90Ψ ↗',
            'open_text' => 'Η περίοδος υποβολής ενστάσεων είναι ανοικτή.',
            'closed_text' => 'Η προθεσμία υποβολής ενστάσεων έχει λήξει.'
        ),
        array(
            'title' => 'Καλλιτεχνικά Σχολεία — ενστάσεις προσωρινού πίνακα ωρομίσθιου προσωπικού',
            'meta_html' => 'Ενστάσεις για τη μοριοδότηση υποψηφίων στα αντικείμενα Κινηματογράφου, Κίνησης–Χορού, Κλασικού και Σύγχρονου Χορού · από <strong>23/09/2026</strong> έως και <strong>28/09/2026</strong>. Η ανακοίνωση δεν ορίζει συγκεκριμένη ώρα λήξης.',
            'start' => '2026-09-23T00:00:00+03:00',
            'end_exclusive' => '2026-09-29T00:00:00+03:00',
            'source_url' => 'https://www.minedu.gov.gr/site/70884-22-09-26-prosorinos-axiologikos-pinakas-katataxes-ypopsephion-gia-ten-proslepse-oromisthiou-prosopikou-exeidikeumenou-sta-antikeimena-ton-kateuthynseon-theatrou-kinematographou-kai-chorou-sta-kallitechnika-scholeia-gia-to-didaktiko-etos-2026-2027',
            'source_label' => 'ΥΠΑΙΘΑ — Προσωρινός πίνακας Καλλιτεχνικών Σχολείων 22/09/2026 ↗',
            'open_text' => 'Η περίοδος υποβολής ενστάσεων είναι ανοικτή.',
            'closed_text' => 'Η προθεσμία υποβολής ενστάσεων έχει λήξει.'
        ),
        array(
            'title' => 'Α2 φάση αναπληρωτών / ΕΕΠ–ΕΒΠ — ανάληψη υπηρεσίας',
            'meta_html' => '202 αναπληρωτές εκπαιδευτικοί και 71 μέλη ΕΕΠ–ΕΒΠ · ανάληψη υπηρεσίας από <strong>24/09/2026</strong> έως και <strong>25/09/2026, 14:30</strong>. Η ψηφιακή σύμβαση είναι διαθέσιμη την ημέρα ανάληψης από 00:01 έως 14:59.',
            'start' => '2026-09-24T00:00:00+03:00',
            'end' => '2026-09-25T14:30:00+03:00',
            'source_url' => 'https://www.minedu.gov.gr/anaplirotes',
            'source_label' => 'ΥΠΑΙΘΑ — Οδηγίες τρέχουσας φάσης αναπληρωτών ↗',
            'open_text' => 'Η περίοδος ανάληψης υπηρεσίας είναι ανοικτή.',
            'closed_text' => 'Η προθεσμία ανάληψης υπηρεσίας έχει λήξει.'
        ),
        array(
        ...
        array(
            ...
            'meta_html' => 'Ηλεκτρονική υποβολή δικαιολογητικών εγγραφής για τους επιλαχόντες που περιλαμβάνονται στους πίνακες της 1ης πρόσκλησης · από <strong>08/09/2026, 10:00</strong> έως <strong>10/09/2026, 23:59</strong>.',
            'start' => '2026-09-08T10:00:00+03:00',
            'end' => '2026-09-10T23:59:00+03:00',
            'source_url' => 'https://www.aspete.gr/07-09-2026-1i-prosklisi-epilachonton-eppaik-pesyp/',
            'source_label' => 'ΑΣΠΑΙΤΕ — 1η πρόσκληση επιλαχόντων 07/09/2026 ↗',
            'open_text' => 'Η περίοδος ηλεκτρονικής υποβολής δικαιολογητικών είναι ανοικτή.',
            'closed_text' => 'Η προθεσμία ηλεκτρονικής υποβολής δικαιολογητικών έχει λήξει.',
            'tool_url' => 'paidagogiki-eparkeia.php',
            'tool_label' => 'Παιδαγωγική επάρκεια →'
        ),
        array(
            'title' => 'ΑΣΠΑΙΤΕ — Εντεταλμένοι Διδάσκοντες Τμήματος Εκπαιδευτικών Πολιτικών Μηχανικών',
            'meta_html' => 'Ηλεκτρονικές αιτήσεις για πρόσληψη εντεταλμένων διδασκόντων πλήρους ή μερικής απασχόλησης για το ακαδημαϊκό έτος 2026–2027 · από <strong>07/09/2026</strong> έως <strong>22/09/2026, 23:59</strong>. Δυνατότητα υποψηφιότητας έχουν επιστήμονες αναγνωρισμένου επιστημονικού κύρους, κάτοχοι διδακτορικού διπλώματος.',
            'start' => '2026-09-07T00:00:00+03:00',
            'end' => '2026-09-22T23:59:00+03:00',
            'source_url' => 'https://www.aspete.gr/2026-2027-tmima-politikon-michanikon-prosklisi-entetalmenon-didaskonton/',
            'source_label' => 'ΑΣΠΑΙΤΕ — Προκήρυξη · ΑΔΑ ΡΧΖΛ46Ψ8ΧΙ-1ΩΘ ↗',
            'open_text' => 'Η περίοδος ηλεκτρονικής υποβολής αιτήσεων είναι ανοικτή.',
            'closed_text' => 'Η προθεσμία ηλεκτρονικής υποβολής αιτήσεων έχει λήξει.'
        ),
        array(
