    ...
    function legalSourcesRegistry()
    {
        ...
        $registry = array(
            ...
            'eneegyl_assignments_2026' => array(
                ...
                'amended_by' => array('eneegyl_assignments_2026_5733'),
            ),
            'eneegyl_assignments_2026_5733' => array(
                'title' => 'Τροποποίηση αναθέσεων μαθημάτων ΕΝ.Ε.Ε.ΓΥ.-Λ. — Μουσική και Μουσικοκινητική Αγωγή',
                'citation_title' => 'Τροποποίηση αναθέσεων ΕΝ.Ε.Ε.ΓΥ.-Λ.',
                'decision' => 'Υ.Α. 121386/Δ3/16-09-2026',
                'fek' => 'ΦΕΚ Β΄ 5733/22-09-2026',
                'date' => '2026-09-16',
                'url' => 'https://search.et.gr/el/fek/?fekId=805734',
                'valid_from' => '2026-2027',
                'school_types' => array('eneegyl_gymnasio', 'eneegyl_lykeio'),
                'topics' => array('teaching_assignments', 'special_education', 'vocational_special_education', 'music'),
                'link_label' => 'ΦΕΚ Β΄ 5733/2026 — Τροποποίηση αναθέσεων ΕΝ.Ε.Ε.ΓΥ.-Λ. ↗',
                'amends' => array('eneegyl_assignments_2026'),
            ),
            ...
            'eeeek_assignments_2018' => array(
                ...
                'amended_by' => array('eeeek_assignments_2026_5733'),
            ),
            'eeeek_assignments_2026_5733' => array(
                'title' => 'Τροποποίηση αναθέσεων μαθημάτων Ε.Ε.Ε.ΕΚ. — Μουσική',
                'citation_title' => 'Τροποποίηση αναθέσεων Ε.Ε.Ε.ΕΚ.',
                'decision' => 'Υ.Α. 121314/Δ3/16-09-2026',
                'fek' => 'ΦΕΚ Β΄ 5733/22-09-2026',
                'date' => '2026-09-16',
                'url' => 'https://search.et.gr/el/fek/?fekId=805734',
                'valid_from' => '2026-2027',
                'school_types' => array('eeeek'),
                'topics' => array('teaching_assignments', 'special_education', 'eeeek', 'music'),
                'link_label' => 'ΦΕΚ Β΄ 5733/2026 — Τροποποίηση αναθέσεων Ε.Ε.Ε.ΕΚ. ↗',
                'amends' => array('eeeek_assignments_2018'),
            ),
            ...
            'epal_assignments_2026_5710' => array(
                'title' => 'Τροποποίηση αναθέσεων ΕΠΑ.Λ. — Μουσικοκινητική Αγωγή Γ΄ τάξης',
                'citation_title' => 'Μουσικοκινητική Αγωγή Γ΄ ΕΠΑ.Λ.',
                'decision' => 'Υ.Α. Φ22/119408/Δ4/11-09-2026',
                'fek' => 'ΦΕΚ Β΄ 5710/22-09-2026',
                'date' => '2026-09-11',
                'url' => 'https://search.et.gr/el/fek/?fekId=805702',
                'valid_from' => '2026-2027',
                'school_types' => array('epal', 'esperino_epal'),
                'topics' => array('teaching_assignments', 'vocational_education', 'music'),
                'amends' => array('epal_assignments_2018'),
                'link_label' => 'ΦΕΚ Β΄ 5710/2026 — Μουσικοκινητική Αγωγή Γ΄ ΕΠΑ.Λ. ↗',
            ),
            ...
            'pepal_g_assignments_2023' => array(
                ...
                'amended_by' => array('pepal_g_assignments_2026_5710'),
            ),
            'pepal_g_assignments_2026_5710' => array(
                'title' => 'Τροποποίηση αναθέσεων Γ΄ Π.ΕΠΑ.Λ. — Μουσικοκινητική Αγωγή',
                'citation_title' => 'Μουσικοκινητική Αγωγή Γ΄ Π.ΕΠΑ.Λ.',
                'decision' => 'Υ.Α. Φ9/119412/Δ4/11-09-2026',
                'fek' => 'ΦΕΚ Β΄ 5710/22-09-2026',
                'date' => '2026-09-11',
                'url' => 'https://search.et.gr/el/fek/?fekId=805702',
                'valid_from' => '2026-2027',
                'school_types' => array('pepal'),
                'topics' => array('teaching_assignments', 'vocational_education', 'model_vocational_school', 'music'),
                'amends' => array('pepal_g_assignments_2023'),
                'link_label' => 'ΦΕΚ Β΄ 5710/2026 — Μουσικοκινητική Αγωγή Γ΄ Π.ΕΠΑ.Λ. ↗',
            ),
            ...
            'epal_day_ab_timetable_2026' => array(
                ...
                'decision' => 'Υ.Α. Φ2/44260/Δ4/08-04-2026',
            ...
            'epal_evening_a_timetable_2026' => array(
                ...
                'decision' => 'Υ.Α. Φ2/44268/Δ4/08-04-2026',
                'fek' => 'ΦΕΚ Β΄ 2151/16-04-2026',
                'date' => '2026-04-08',
                'url' => 'https://www.minedu.gov.gr/images/joomlart/PDFs/2026_04_08_EXE_44260_tropop_YA_OPS_mathema_ETHIKE_A_B_EPAL_PHEK_2151B_16.04.2026.pdf',
                'valid_from' => '2026-2027',
            ...
            'epal_naval_timetable_2018' => array(
                ...
                'decision' => 'Κ.Υ.Α. Φ2/129460/Δ4/30-07-2018',
            ...
            'pepal_a_timetable_2026' => array(
                ...
                'citation_title' => 'Α΄ Π.ΕΠΑ.Λ.',
                'decision' => 'Υ.Α. Φ9/44281/Δ4/08-04-2026',
            ...
            'pepal_b_timetable_2026' => array(
                ...
                'citation_title' => 'Β΄ Π.ΕΠΑ.Λ.',
                'decision' => 'Υ.Α. Φ9/44286/Δ4/08-04-2026',
                'fek' => 'ΦΕΚ Β΄ 2136/09-04-2026',
                'date' => '2026-04-08',
                'url' => 'https://www.minedu.gov.gr/images/joomlart/PDFs/2026_04_08_EXE_44286_tropop_YA_OPS_mathema_ETHIKE_B_PEPAL_PHEK_2136B_09.04.2026.pdf',
                'valid_from' => '2026-2027',
