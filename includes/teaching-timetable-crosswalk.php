...
function teachingTimetableLanguageChoiceOptionsForRow($row)
{
    ...
    // Γ΄ Ημερήσιου και τριετούς Εσπερινού ΕΠΑ.Λ. — Υπάλληλος
    // Τουριστικών Επιχειρήσεων. Το ΦΕΚ Β΄ 2122/2018 αντικατέστησε στο
    // ημερήσιο και στο τότε εσπερινό πρόγραμμα το «Γαλλικά ή Γερμανικά»
    // με επιλογή μίας από τέσσερις γλώσσες. Το τριετές Εσπερινό ΕΠΑ.Λ.
    // διατηρεί την ίδια τετράγλωσση επιλογή στο ΦΕΚ Β΄ 2636/2018.
    // Για κατανομή πραγματικών ωρών δεν αρκεί το broad assignment row:
    // η επιλογή γλώσσας πρέπει να οδηγεί στον αντίστοιχο κλάδο ΠΕ.
    if (in_array($school, array('epal', 'esperino_epal'), true) && $specialty === 'tourism'
