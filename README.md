...
- Το cross-audit ταξινομεί πλέον και τις 2.023/2.023 περιπτώσεις. Η πλήρης ταξινόμηση δεν σημαίνει ότι όλες έχουν διαθέσιμη ανάθεση: τα 29 τεκμηριωμένα `regulatory_gap` παραμένουν σκόπιμα κενά.
