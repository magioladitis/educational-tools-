...
<body class="edu-ui edu-calc-standard edu-page-teaching-hours">
...
<?php calculatorContainerStart(array('class' => 'app')); ?>
  ...
  <?php calculatorColumnsStart(); ?>
    <?php calculatorMainStart(); ?>
      <?php calculatorCardStart(array('title' => 'Στοιχεία προσωπικού')); ?>
        <div class="field-grid">
          ...
          <div class="field" id="serviceYearsField">
            <label for="serviceYears">Συμπληρωμένα έτη υπηρεσίας<small>Αναγνωρισμένος χρόνος για τη μείωση του ωραρίου.</small></label>
        ...
        <?php calculatorDisclosure(array(
          'id' => 'serviceInfo',
          'summary' => 'Ποιος χρόνος υπηρεσίας προσμετράται;',
          'html' => 'Για τη μείωση του ωραρίου λαμβάνεται υπόψη ο <strong>αναγνωρισμένος χρόνος υπηρεσίας</strong> που προβλέπεται από τις σχετικές διατάξεις. Για τους εκπαιδευτικούς περιλαμβάνονται και οι προσφερθείσες υπηρεσίες ως αναπληρωτή/ωρομίσθιου κατόπιν πρόσληψης από το ΥΠΑΙΘ, όπως π.χ. σε ΚΕΣΥ/ΚΕΔΑΣΥ. Καταχώρισε το υπόλοιπο ημερών όπως προκύπτει από την αναγνωρισμένη υπηρεσία (0–29 ημέρες). <a href="https://diavgeia.gov.gr/doc/4%CE%99%CE%9949-%CE%9F9?inline=true" target="_blank" rel="noopener noreferrer">Δες ποια προϋπηρεσία προσμετράται ↗</a>'
        )); ?>
        ...
        <div id="primaryFields">
          ...
          <?php calculatorDisclosure(array(
            'summary' => 'Πότε εφαρμόζεται η μείωση στην Πρωτοβάθμια;',
            'html' => 'Στην Πρωτοβάθμια, όταν το απαιτούμενο όριο υπηρεσίας για μείωση ωραρίου συμπληρώνεται έως τις <strong>31 Δεκεμβρίου</strong>, η μείωση εφαρμόζεται από 1η Σεπτεμβρίου του ίδιου σχολικού έτους. Καταχώρισε τον χρόνο υπηρεσίας που πρέπει να ληφθεί υπόψη για το σχολικό έτος που ελέγχεις.'
          )); ?>
        </div>
      ...
      <?php calculatorDisclosure(array(
        'summary' => 'Τι ακριβώς υπολογίζει το εργαλείο;',
    ...
    <?php calculatorResultsStart(array('aria_live' => 'polite')); ?>
      ...
      <?php calculatorDisclosure(array(
        ...
        'summary' => 'Πώς προέκυψε το αποτέλεσμα;',
        'html' => '<div id="ruleResult">—</div>'
      )); ?>
