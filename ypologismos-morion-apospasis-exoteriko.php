...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .stipend-panel{margin-top:14px;border:1px solid #cfe0ff;border-radius:14px;background:#f7faff;padding:15px}
    .stipend-panel h3{margin:0 0 4px;font-size:17px;color:var(--blue-dark)}
    .stipend-panel .stipend-intro{margin:0 0 11px;color:var(--muted);font-size:13px}
    .stipend-table{width:100%;border-collapse:collapse;font-size:14px}
    .stipend-table th,.stipend-table td{padding:9px 8px;border-top:1px solid #dfe8f6;text-align:left;vertical-align:top}
      ...
      <section class="card">
        ...
        <div class="field-grid">
          ...
          <div class="field">
            ...
            <div class="note" style="margin-top:0">Ο έλεγχος του Παραρτήματος ΙΙΙ γίνεται πλέον αυτόματα — δεν χρειάζεται να δηλώσεις εσύ αν η ειδικότητα είναι αποδεκτή.</div>
          </div>
