...
check('gross includes position', 'result.basicGrossSalary + familyAllowance + positionAllowance + remoteAllowance' in page)
check('separate result row', 'positionAllowanceResult' in page)
check('reset clears position', "byId('positionAllowance').value = 'none'" in page)
