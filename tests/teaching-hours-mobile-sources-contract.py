...
check('teaching-hours opts into responsive source card', 'sourceCardDisclosureStart' in page and "'mobile_collapsed' => true" in page)
check('legacy source card close replaced for pilot', 'sourceCardDisclosureEnd();' in page)
...
check('desktop default remains open', "'open' => true" in page)
