...
check('central cache version present', "define('EDU_TOOLS_VERSION'" in config and "3.20.75" in config)
...
check('salary disclaimer distinguishes basic from total pay', 'βασικό μισθό του Μ.Κ.' in page and 'Δεν προστίθενται οικογενειακή παροχή' in page and 'βασικό μικτό μισθό' in page)
