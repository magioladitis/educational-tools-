...
check('central cache version present', "define('EDU_TOOLS_VERSION'" in config and "3.20.72" in config)
...
check('salary disclaimer distinguishes basic from total pay', 'Δεν υπολογίζονται συνολικές ή καθαρές αποδοχές' in page and 'βασικός μισθός (μικτά)' in page)
