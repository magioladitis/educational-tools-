...
check('service years capped at 40', 'id="serviceYears" type="number" min="0" max="40"' in page)
check('MSD years capped at 40', 'class="msd-years" type="number" min="0" max="40"' in page)
check('year input clamp capped at 40', "clampInput(target, 40);" in page and "clampInput(target, 60);" not in page)
...
check('asset version 3.20.68', "EDU_TOOLS_VERSION', '3.20.68'" in config)
