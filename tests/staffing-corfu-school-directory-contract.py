...
check('full 2026-2027 dataset is embedded', "dataset_version:'2026-2027-full-v1'" in js and "filename:'school_registry_v1-dde-kerkyras-2026-2027-full.csv'" in js)
...
check('directory status explains populated structural data', 'διαθέσιμα στοιχεία βασικών τμημάτων' in page and 'πλήρες μητρώο 2026-2027' in page)
...
check('pending-field metadata is preserved', '2ης ξένης γλώσσας' in data.get('code2401020',{}).get('pending_fields','') and 'Γ Μαθηματικά 2ου πεδίου' in data.get('gel1',{}).get('pending_fields',''))
