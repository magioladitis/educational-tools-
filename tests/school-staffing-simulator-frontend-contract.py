...
check('automatic proposal is exposed but not presented as official placement', 'Αυτόματη πρόταση + χειροκίνητη κατανομή μαθημάτων' in get and 'Η αυτόματη λειτουργία δημιουργεί <strong>πρόταση</strong>, όχι διοικητική πράξη τοποθέτησης.' in get)
