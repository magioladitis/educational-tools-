...
check('portable registry template uses versioned semicolon schema', "['Έκδοση μητρώου','Αναγνωριστικό','Κλάδος','2η ειδικότητα','Ονοματεπώνυμο','Υποχρεωτικό ωράριο','Ρόλος'" in text and "'staff_registry_v1'" in text)
check('CSV mapping exposes secondary specialty', "{key:'secondary_specialty_code',label:'2η ειδικότητα'}" in text)
check('portable registry excludes sensitive identifiers', 'ΑΦΜ' not in text and 'Αριθμός Μητρώου' not in text)
