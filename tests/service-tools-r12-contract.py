...
check('hours UI hard-clamps years while typing', "el.id === 'serviceYears'" in page_hours and 'clampBoundedIntegerInput(el, 50)' in page_hours)
...
check('salary UI hard-clamps years while typing', "el.id === 'serviceYears'" in page_salary and 'clampBoundedIntegerInput(el, 50)' in page_salary)
...
check('toolbox results count matches cards', f'Εμφανίζονται {toolbox_card_count} εργαλεία.' in tools)
