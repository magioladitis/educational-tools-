...
check('net engine called from total gross', 'EducationSalaryNet.calculate' in page and 'grossMonthly: grossForNet' in page)
check('gross basis disclaimer', 'βασικό μισθό του Μ.Κ.' in page and 'επίδομα απομακρυσμένων - παραμεθορίων περιοχών' in page and 'Δεν προστίθενται οικογενειακή παροχή' in page)
...
check('MTPY source', 'ΜΤΠΥ — Οδηγός κρατήσεων' in page)
...
check('asset version bumped', "define('EDU_TOOLS_VERSION', '3.20.75')" in config)
