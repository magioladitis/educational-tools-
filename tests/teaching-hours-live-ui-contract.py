...
check('live event selection retained', "const eventName = el.tagName === 'SELECT'" in ui and "? 'change' : 'input'" in ui)
check('single live listener retained', 'el.addEventListener(eventName' in ui and 'calculate();' in ui)
