...
check('engine old TPDY base is basic', 'const lumpSumBase = oldInsured ? earnings.basic : insuredGrossExcludingPersonalDifference' in net)
check('engine old pension base is basic plus position', 'const pensionBase = oldInsured ? basicAndPosition : insuredGrossExcludingPersonalDifference' in net)
