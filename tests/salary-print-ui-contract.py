...
need('FMY result label', 'Φ.Μ.Υ. — μηνιαία παρακράτηση φόρου')
need('FMY deduction print label', 'Φόρος εισοδήματος (Φ.Μ.Υ.) — μηνιαία παρακράτηση')
need('FMY print summary label', 'Φ.Μ.Υ. — μηνιαία παρακράτηση φόρου:')
