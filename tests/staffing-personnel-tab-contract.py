...
check('shared personnel workload JS included', 'includes/personnel-workload-calculations.js' in out)
check('client uses personnel workload parity calculator', 'PersonnelWorkloadCalculations.secondaryObligation' in source)
