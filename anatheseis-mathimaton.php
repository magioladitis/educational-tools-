    ...
    <?php calculatorMainStart(); ?>
      <?php calculatorCardStart(); ?>
        ...
        <div class="field">
          ...
          <div class="school-type-group">
            ...
            <div class="school-type-options">
              ...
              <div class="checkrow">
                ...
                <label for="schoolMousikoLykeio">Γενικό Μουσικό Λύκειο <small>(φάση 1 · θεωρητικό block)</small></label>
              </div>
            </div>
          </div>
          ...
          <p class="help"><strong>Μουσικά Σχολεία:</strong> το <strong>Μουσικό Γυμνάσιο</strong> έχει πλήρες block μουσικής παιδείας. Για το <strong>Γενικό Μουσικό Λύκειο</strong> έχει ξεκινήσει η φάση 1 με τα ασφαλώς αντιστοιχισμένα θεωρητικά μαθήματα: Αρμονία, Ανάπτυξη Ακουστικών Ικανοτήτων, Ιστορία της Μουσικής και Μορφολογία. Δεν έχει προστεθεί ακόμη η Ελληνική Παραδοσιακή Μουσική του ωρολογίου 2026, επειδή δεν υπάρχει αντίστοιχη ρητή γραμμή στον πίνακα αναθέσεων του 2018. Τα οργανικά μαθήματα, η τεχνολογία/παραγωγή, τα μαθήματα επιλογής και τα Μουσικά Σύνολα του Λυκείου θα προστεθούν σε επόμενες ελεγχόμενες φάσεις.</p>
...
(function(){
  ...
  function schoolLabel(row){
    ...
    if (row.school === 'mousiko_lykeio') return row.grade ? `${row.grade} Γενικού Μουσικού Λυκείου` : 'Γενικό Μουσικό Λύκειο';
