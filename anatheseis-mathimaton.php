    ...
    <?php calculatorMainStart(); ?>
      <?php calculatorCardStart(); ?>
        ...
        <div class="field">
          ...
          <div class="school-type-group">
            ...
            <div class="school-type-options">
              <div class="checkrow">
                ...
                <label for="schoolEpal">ΕΠΑ.Λ. <small>(Α΄ πλήρης · Β΄/Γ΄ Γενικής Παιδείας · 3 Τομείς Β΄)</small></label>
              </div>
              <div class="checkrow">
          ...
          <p class="help"><strong>ΕΠΑ.Λ.:</strong> ενεργοποιήθηκε η υπάρχουσα βάση για Α΄ τάξη (Γενικής Παιδείας, Προσανατολισμού και Επιλογής), Β΄/Γ΄ Γενικής Παιδείας και προστέθηκαν οι <strong>Τομείς Γεωπονίας, Τροφίμων και Περιβάλλοντος</strong>, <strong>Διοίκησης και Οικονομίας</strong> και <strong>Δομικών Έργων, Δομημένου Περιβάλλοντος και Αρχιτεκτονικού Σχεδιασμού της Β΄ τάξης</strong>. Οι υπόλοιποι Τομείς Β΄ και οι Ειδικότητες Γ΄ θα προστεθούν σταδιακά με έλεγχο ανά πίνακα.</p>
