    ...
    <?php calculatorMainStart(); ?>
      <?php calculatorCardStart(); ?>
        ...
        <div class="field">
          ...
          <div class="school-type-group">
            ...
            <div class="school-type-options">
              <div class="checkrow">
                ...
                <label for="schoolEpal">ΕΠΑ.Λ. <small>(Α΄ πλήρης · Β΄/Γ΄ Γενικής Παιδείας · 9 Τομείς Β΄)</small></label>
              </div>
              <div class="checkrow">
          ...
          <p class="help"><strong>ΕΠΑ.Λ.:</strong> πλήρης κάλυψη της <strong>Β΄ τάξης ως προς όλους τους 9 Τομείς</strong>, μαζί με την Α΄ τάξη (Γενικής Παιδείας, Προσανατολισμού και Επιλογής) και τα Γενικής Παιδείας Β΄/Γ΄. Για τον Τομέα Ναυτιλιακών Επαγγελμάτων χρησιμοποιείται η ειδική Υ.Α. Φ22/134291/Δ4/2018 (ΦΕΚ Β΄ 3520), ενώ για τον Τομέα Υγείας – Πρόνοιας – Ευεξίας έχει ενσωματωθεί η τροποποίηση Φ22/105626/Δ4/2019 (ΦΕΚ Β΄ 2779). Απομένουν οι Ειδικότητες της Γ΄ τάξης.</p>
