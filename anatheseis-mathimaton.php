...
<?php sourceCardStart(); ?>
  <p><strong>Γυμνάσιο / Εσπερινό Γυμνάσιο / ΓΕΛ / Εσπερινό ΓΕΛ:</strong> Υ.Α. 54058/Δ2/05-05-2026, ΦΕΚ Β΄ 2583/07-05-2026. Η απόφαση έχει ενιαίο πίνακα αναθέσεων για Γυμνάσιο και ΓΕΛ· τα εσπερινά χρησιμοποιούν τον αντίστοιχο πίνακα του ίδιου τύπου σχολείου.</p>
  ...
  <p><strong>ΕΠΑ.Λ. / Εσπερινά ΕΠΑ.Λ.:</strong> Υ.Α. Φ22/75401/Δ4/10-05-2018, ΦΕΚ Β΄ 1664/15-05-2018, όπως τροποποιήθηκε και ισχύει. Για τις ειδικότητες της Γ΄ εφαρμόζονται επίσης τα ΦΕΚ Β΄ 2637/2018, 2779/2019, 3609/2020 και η Υ.Α. Φ22/134291/Δ4/2018 (ΦΕΚ Β΄ 3520/21-08-2018).</p>
  ...
  <p><strong>Καλλιτεχνικά Σχολεία:</strong> Υ.Α. 65409/Δ2/12-06-2024, ΦΕΚ Β΄ 3418/13-06-2024, η οποία τροποποιεί την Υ.Α. 148262/Δ2/10-09-2018 (ΦΕΚ Β΄ 4077). Για την κάλυψη ωρών Α΄ και Β΄ ανάθεσης εφαρμόζεται και η Υ.Α. 85980/Δ2/03-07-2020 (ΦΕΚ Β΄ 2737).</p>
  <p><strong>Μουσικά Σχολεία:</strong> Υ.Α. 144236/Δ2/05-09-2018, ΦΕΚ Β΄ 4202/25-09-2018, σε αντιπαραβολή με το ισχύον ωρολόγιο πρόγραμμα 43787/Δ2/07-04-2026, ΦΕΚ Β΄ 2107/09-04-2026. Όπου η ανάθεση εξαρτάται από μουσική ειδίκευση εφαρμόζονται οι ειδικοί κανόνες του πίνακα αναθέσεων. Για μαθήματα του ωρολογίου χωρίς ρητή ή ασφαλώς ισοδύναμη αντιστοίχιση στον πίνακα του 2018 δεν εμφανίζεται ανάθεση. Το ίδιο σύνολο μαθημάτων επιλογής της Γ΄ Λυκείου υπήρχε ήδη στο ωρολόγιο του 2020 (ΦΕΚ Β΄ 3523).</p>
