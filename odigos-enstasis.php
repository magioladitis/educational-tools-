...
<h1>Οδηγός ένστασης ΑΣΕΠ</h1>
  ...
  <div class="paravolo-summary">
    ...
    <ul>
      ...
      <li><strong>Προσοχή:</strong> μην χρησιμοποιήσεις τον <b>25ψήφιο κωδικό πληρωμής RF</b>· χρησιμοποιείται μόνο για την πληρωμή του παραβόλου.</li>
    </ul>
  </div>
...
function showGuidance(){
  ...
  html += '<div class="note-box"><ul>' +
          ...
          '<li><strong>Όχι ο κωδικός RF:</strong> ο 25ψήφιος RF αφορά μόνο την πληρωμή</li>' +
          '</ul></div>';

  if(paravolo === 'paid'){
    html += '<div class="success-box">Το παράβολο είναι πληρωμένο. Έλεγξε ότι στην ένσταση έχεις καταχωρίσει τον <strong>20ψήφιο κωδικό e-Παραβόλου, χωρίς κενά</strong> και όχι τον 25ψήφιο κωδικό πληρωμής RF.</div>';
  }
  ...
  html += '<div class="note-box"><ol>' +
          ...
          '<li>Ανάγραψε τον <strong>20ψήφιο κωδικό e-Παραβόλου χωρίς κενά</strong> στην ένσταση.</li>' +
  ...
  html += '<div class="warning-box"><strong>Τελικός έλεγχος πριν την υποβολή:</strong><ul>' +
          ...
          '<li>σωστός <strong>20ψήφιος κωδικός e-Παραβόλου χωρίς κενά</strong> (όχι ο 25ψήφιος RF),</li>' +
