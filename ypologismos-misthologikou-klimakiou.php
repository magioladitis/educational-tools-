      ...
      <?php calculatorCardStart(array('title' => 'Στοιχεία μισθολογικής κατάταξης')); ?>
        ...
        <div class="field-grid">
          ...
          <div class="field">
            ...
            <small id="insuredStatusHelp">Κριτήριο παλαιού/νέου είναι η <strong>πρώτη ασφάλιση για κύρια σύνταξη</strong>, όχι η ημερομηνία διορισμού στο Δημόσιο. Στους νέους ασφαλισμένους μπορείς να δηλώσεις αν η επικουρική είναι στον e-ΕΦΚΑ ή στο ΤΕΚΑ· <strong>το 3% και η ασφαλιστέα βάση δεν αλλάζουν</strong>, αλλά αλλάζει ο φορέας που εμφανίζεται στην ανάλυση. Στον αναπληρωτή / ΙΔΟΧ με ΚΠΚ 101 η επιλογή δεν μεταβάλλει την παρούσα εκτίμηση.</small>
          </div>
          <div class="field">
          ...
          <details class="info-note edu-field--full" id="insuredStatusInfoPanel">
            ...
            <p><strong>Επικουρική e-ΕΦΚΑ ή ΤΕΚΑ:</strong> για τον νέο ασφαλισμένο η εργατική εισφορά επικουρικής παραμένει <strong>3%</strong> και η <strong>βάση υπολογισμού παραμένει ίδια</strong>. Η επιλογή ΤΕΚΑ αλλάζει μόνο τον φορέα που αναγράφεται στη σύνθεση κρατήσεων και στην εκτύπωση· δεν αλλάζει το ποσό των κρατήσεων από μόνη της.</p>
            <small>Η υγειονομική περίθαλψη 2,05% και η εισφορά 2% για την καταπολέμηση της ανεργίας υπολογίζονται στις αντίστοιχες τακτικές αποδοχές και δεν διαφοροποιούνται εδώ μόνο λόγω χαρακτηρισμού «παλαιός/νέος» ή φορέα επικουρικής. Ειδικά ασφαλιστικά καθεστώτα μπορεί να απαιτούν διαφορετική αντιμετώπιση.</small>
          </details>
