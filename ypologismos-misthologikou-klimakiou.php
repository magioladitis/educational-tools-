...
<head>
  ...
  <link rel="stylesheet" href="<?php echo htmlspecialchars(edu_asset_url('assets/salary-scale.css'), ENT_QUOTES, 'UTF-8'); ?>">
</head>
  ...
  <?php calculatorColumnsStart(); ?>
    <?php calculatorMainStart(); ?>
      <?php calculatorCardStart(array('title' => 'Στοιχεία μισθολογικής κατάταξης')); ?>
        ...
        <div class="field-grid">
          ...
          <div class="field edu-field--full">
            <label for="personalDifference">Καταβαλλόμενη προσωπική διαφορά (€ / μήνα)</label>
            <input id="personalDifference" type="number" min="0" step="0.01" value="0" inputmode="decimal" aria-describedby="personalDifferenceHelp">
            <small id="personalDifferenceHelp">Συμπλήρωσέ το μόνο αν εμφανίζεται προσωπική διαφορά στο ενημερωτικό μισθοδοσίας σου.</small>
          </div>
          <div class="edu-field--full">
            <div class="checkrow">
        ...
        <?php calculatorDisclosure(array(
          ...
          'html' => 'Η εκτίμηση καθαρών γίνεται πάνω στον <strong>βασικό μισθό του Μ.Κ.</strong>, στην <strong>οικογενειακή παροχή</strong> που αντιστοιχεί στον δηλωμένο αριθμό τέκνων, στο τυχόν <strong>επίδομα θέσης ευθύνης</strong>, στο <strong>επίδομα απομακρυσμένων - παραμεθορίων περιοχών</strong> και στην <strong>καταβαλλόμενη προσωπική διαφορά</strong>, όταν δηλωθούν, με 12μηνη φορολογική αναγωγή. Άλλες αποδοχές δεν προστίθενται αυτόματα. Η προαιρετική <strong>μειωμένη εισφορά κύριας σύνταξης λόγω μητρότητας</strong> μειώνει μόνο το αντίστοιχο ασφαλιστικό σκέλος. Η <strong>φορολογική ρύθμιση λόγω αναπηρίας</strong> επηρεάζει μόνο τον φόρο εισοδήματος και όχι τις ασφαλιστικές κρατήσεις. Οι προαιρετικές <strong>λοιπές κρατήσεις</strong> αφαιρούνται μόνο από το τελικό πληρωτέο και δεν μεταβάλλουν τον υπολογισμό φόρου. Αν ο αριθμός τέκνων που λαμβάνεται υπόψη για φορολογία διαφέρει από εκείνον της οικογενειακής παροχής, η εκτίμηση χρειάζεται διοικητικό έλεγχο.'
        )); ?>
        <?php calculatorDisclosure(array(
    ...
    <?php calculatorResultsStart(array('aria_live' => 'polite')); ?>
      ...
      <?php calculatorDisclosureStart(array(
        ...
        <?php calculatorResultRow(array('label' => 'Προσωπική διαφορά', 'value' => '0,00 €', 'value_id' => 'personalDifferenceResult')); ?>
...
<?php sourceCardStart(); ?>
  ...
  <p><strong>Προσωπική διαφορά:</strong> καταχωρίζεται χειροκίνητα το ποσό που πράγματι εμφανίζεται στη μισθοδοσία. Η προσωπική διαφορά του άρθρου 27 παρ. 1 ν. 4354/2015 προστίθεται στις μικτές και φορολογητέες αποδοχές, αλλά δεν αποτελεί συντάξιμη αποδοχή. Στην εκτίμηση δεν επιβαρύνεται με κύρια/επικουρική σύνταξη, υγειονομική περίθαλψη ή εφάπαξ, ενώ για μέτοχο ΜΤΠΥ εφαρμόζεται η ειδική κράτηση <strong>2%</strong>. Η ειδική εισφορά 2% για την καταπολέμηση της ανεργίας εξακολουθεί να υπολογίζεται επί των τακτικών αποδοχών.</p>
  ...
  <?php sourceCardLinksStart(); ?>
    ...
    <?php sourceCardLink('https://minfingen.gr/web/31511/m.t.p.y.', 'ΜΤΠΥ — Προσωπική διαφορά ν. 4354/2015: κράτηση 2% ↗'); ?>
