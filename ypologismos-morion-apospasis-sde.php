...
<main class="page-shell">
  ...
  <section class="hero">
    ...
    <div class="hero-meta">
      ...
      <span>Εκπαίδευση: 23</span>
      <span>Διδακτική εμπειρία: 13</span>
      <span>Άλλα προσόντα: 4</span>
    </div>
  </section>
  ...
  <div class="layout">
    <div>
      ...
      <section class="card">
        <div class="section-head"><div><h2>2. Εκπαίδευση</h2><p class="subtitle">Τυπικά προσόντα έως 19 + επιμόρφωση έως 4.</p></div><div class="max">έως 23</div></div>
        <div class="field-grid">
          <div class="field">
            <label for="phd">Διδακτορικό <small>10 μόρια στην Εκπαίδευση Ενηλίκων / Συνεχιζόμενη / Διά Βίου, 9 σε άλλη κατεύθυνση.</small></label>
            <select id="phd" onchange="calculate()"><option value="none">Κανένα</option><option value="adult">Εκπαίδευση Ενηλίκων / Συνεχιζόμενη / Διά Βίου — 10</option><option value="other">Άλλη κατεύθυνση — 9</option></select>
          </div>
          <div class="field">
            <label for="master">Μεταπτυχιακό <small>7 μόρια στην Εκπαίδευση Ενηλίκων / Συνεχιζόμενη / Διά Βίου, 6 σε άλλη κατεύθυνση. Αν δηλωθεί και διδακτορικό, αυτός ο τίτλος δεν προσμετράται.</small></label>
            <select id="master" onchange="calculate()"><option value="none">Κανένα</option><option value="adult">Εκπαίδευση Ενηλίκων / Συνεχιζόμενη / Διά Βίου — 7</option><option value="other">Άλλη κατεύθυνση — 6</option></select>
          </div>
          <div class="field">
          ...
          <div class="field">
            <label for="secondPhd">Δεύτερο διδακτορικό <small>3 μόρια στην Εκπαίδευση Ενηλίκων κ.λπ., 2 σε άλλη κατεύθυνση.</small></label>
            <select id="secondPhd" onchange="calculate()"><option value="none">Κανένα</option><option value="adult">Εκπαίδευση Ενηλίκων / Συνεχιζόμενη / Διά Βίου — 3</option><option value="other">Άλλη κατεύθυνση — 2</option></select>
          </div>
          <div class="field">
            <label for="secondMaster">Δεύτερο μεταπτυχιακό <small>2 μόρια στην Εκπαίδευση Ενηλίκων κ.λπ., 1 σε άλλη κατεύθυνση. Χρησιμοποίησέ το μόνο για διακριτό δεύτερο μεταπτυχιακό τίτλο.</small></label>
            <select id="secondMaster" onchange="calculate()"><option value="none">Κανένα</option><option value="adult">Εκπαίδευση Ενηλίκων / Συνεχιζόμενη / Διά Βίου — 2</option><option value="other">Άλλη κατεύθυνση — 1</option></select>
          </div>
          <div class="field">
            <label for="sdeTrainingHours">Ώρες ολοκληρωμένης επιμόρφωσης σε θέματα ΣΔΕ <small>0,25 μόρια ανά 100 ώρες, έως 2. Μη συμπεριλαμβάνεις επιμορφώσεις μικρότερες των 15 ωρών.</small></label>
            <input type="number" id="sdeTrainingHours" min="0" step="1" value="0" oninput="calculate()">
          </div>
          <div class="field">
            <label for="adultTrainingHours">Ώρες ολοκληρωμένης επιμόρφωσης στις αρχές Εκπαίδευσης Ενηλίκων <small>0,25 μόρια ανά 100 ώρες, έως 2. Μη συμπεριλαμβάνεις επιμορφώσεις μικρότερες των 15 ωρών.</small></label>
      ...
      <section class="card">
        ...
        <div class="field-grid">
          ...
          <div class="field">
            <label>Τυπική εκπαίδευση πέραν των 2 προαπαιτούμενων ετών <small>Υπολογίζεται αυτόματα από τα συνολικά πλήρη σχολικά έτη που δήλωσες παραπάνω: 1 μόριο/έτος, έως 4.</small></label>
      ...
      <section class="card">
        <div class="section-head"><div><h2>4. Άλλα προσόντα</h2><p class="subtitle">Έως δύο ξένες γλώσσες και γνώση χειρισμού Η/Υ.</p></div><div class="max">έως 4</div></div>
        <div class="field-grid">
          <div class="field">
  ...
  <p class="source-note"><strong>Πηγές / Νομική βάση:</strong><br><strong>Πηγή:</strong> Υ.Α. 88422/Κ1, ΦΕΚ Β΄ 4088/03.07.2026. Το εργαλείο είναι ενδεικτικό. Οι τελικοί πίνακες καταρτίζονται από την αρμόδια Επιτροπή και ισχύουν οι όροι της εκάστοτε πρόσκλησης.</p>
...
<script>
  ...
  function calculate() {
    ...
    $('educationScore').textContent = fmt(result.education.total) + ' / 23';
    $('experienceScore').textContent = fmt(result.experience.total) + ' / 13';
    $('otherScore').textContent = fmt(result.other.total) + ' / 4';
