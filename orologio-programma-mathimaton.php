...
<?php sourceCardStart(); ?>
  ...
  <?php sourceCardLinksStart(); ?>
    ...
    <?php sourceCardLink('https://www.minedu.gov.gr/protovathmia-defterovathmia/dioikitika-themata-geniko-lykeio', 'ΦΕΚ Β΄ 2583/2026 — Αναθέσεις γενικής παιδείας Καλλιτεχνικών Σχολείων / διασταύρωση ↗'); ?>
