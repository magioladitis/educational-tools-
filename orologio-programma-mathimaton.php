...
<main id="weeklyTimetableTool" class="app">
  ...
  <?php calculatorHero(array(
    ...
    'meta_class' => 'meta',
    'badges' => array('2026–2027', 'Γυμνάσιο & ΓΕΛ', 'ΕΠΑ.Λ. & Π.ΕΠΑ.Λ.', 'ΕΝ.Ε.Ε.ΓΥ.-Λ.', 'Ε.Ε.Ε.ΕΚ.', 'Ημερήσιο & Εσπερινό', 'Καλλιτεχνικά', 'Μουσικά')
  )); ?>
